...
const Item = ({item}) => {
  return (
    <motion.div initial={{opacity:0, scale:0.9}} whileInView={{opacity:1, scale:1}} transition={{duration:0.8}} className='w-full flex flex-col items-center justify-between gap-1 bg-white shadow overflow-hidden p-1 sm:p-2 rounded-lg'>
