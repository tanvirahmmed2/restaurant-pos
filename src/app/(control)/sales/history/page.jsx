  ...
  return (
    <div className='w-full flex p-4 flex-col items-center justify-center gap-4'>
      ...
      <div className='w-full grid grid-cols-3 gap-4'>
        {
          orders.map((order) => (
            <Link href={`/sales/history/${order._id}`} key={order._id} className='w-full p-2 border border-black/10 rounded-lg flex flex-col items-center justify-center text-sm gap-4'>
