  ...
  return (
    <div className='w-full min-h-screen p-4 flex flex-col md:flex-row items-center justify-center gap-6'>
      ...
      <div className='w-full flex flex-col items-center justify-center gap-4'>
        <h1 className='text-2xl font-semibold border-b-2 px-5 text-center'>Book Your Table</h1>
        <form onSubmit={handleSubmit} className='flex w-full flex-col gap-4'>
          ...
          <div className='w-full flex flex-col gap-2'>
            ...
            <input type="date" id='date' name='date' required onChange={handleChange} value={formData.date} className='border border-black/30 outline-none px-2 p-1 w-full' />
          </div>
          <div className='w-full flex flex-col gap-2'>
            <label htmlFor="member">Member</label>
            <input type="number" id='member' name='member' required onChange={handleChange} value={formData.member} className='border border-black/30 outline-none px-2 p-1 w-full' />
          </div>
          <div className='w-full flex flex-col gap-2'>
            <label htmlFor="table">Table</label>
            <input type="number" id='table' name='table' required onChange={handleChange} value={formData.table} className='border border-black/30 outline-none px-2 p-1 w-full' />
          </div>
          <div className='w-full flex flex-col gap-2'>
